...
#define DETOUR_DECL_STATIC2_STDCALL(name, ret, p1type, p1name, p2type, p2name) \
ret (__stdcall *name##_Actual)(p1type, p2type) = NULL; \
ret __stdcall name(p1type p1name, p2type p2name)
...
#define DETOUR_DECL_STATIC3_STDCALL(name, ret, p1type, p1name, p2type, p2name, p3type, p3name) \
ret (__stdcall *name##_Actual)(p1type, p2type, p3type) = NULL; \
ret __stdcall name(p1type p1name, p2type p2name, p3type p3name)
...
#define DETOUR_DECL_MEMBER2_STDCALL(name, ret, p1type, p1name, p2type, p2name) \
class name##Class \
{ \
public: \
	ret __stdcall name(p1type p1name, p2type p2name); \
	static ret (__stdcall name##Class::* name##_Actual)(p1type, p2type); \
}; \
ret (__stdcall name##Class::* name##Class::name##_Actual)(p1type, p2type) = NULL; \
ret __stdcall name##Class::name(p1type p1name, p2type p2name)
...
#define DETOUR_DECL_MEMBER3_STDCALL(name, ret, p1type, p1name, p2type, p2name, p3type, p3name) \
class name##Class \
{ \
public: \
	ret __stdcall name(p1type p1name, p2type p2name, p3type p3name); \
	static ret (__stdcall name##Class::* name##_Actual)(p1type, p2type, p3type); \
}; \
ret (__stdcall name##Class::* name##Class::name##_Actual)(p1type, p2type, p3type) = NULL; \
ret __stdcall name##Class::name(p1type p1name, p2type p2name, p3type p3name)
